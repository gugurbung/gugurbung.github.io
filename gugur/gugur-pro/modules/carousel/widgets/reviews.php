...
class Reviews extends Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'default',
				'options' => [
					'default' => __( 'Official Color', 'gugur-pro' ),
	...
	protected function get_repeater_defaults() {
		...
		return [
			[
				'content' => __( 'I am slide content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'gugur-pro' ),
	...
	private function print_icon( $slide, $element_key ) {
		...
		$icon = '<i class="' . $slide['social_icon'] . '" aria-hidden="true"></i><span class="gugur-screen-only">' . esc_html__( 'Read More', 'gugur-pro' ) . '</span>';
