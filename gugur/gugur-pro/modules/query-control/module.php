...
class Module extends Module_Base {
	...
	public static function get_query_args( $control_id, $settings ) {
		...
		if ( 'current_query' === $post_type ) {
			 ...
			 */
			$current_query_vars = apply_filters( 'gugur_pro/query_control/get_query_args/current_query', $current_query_vars );
		...
		if ( ! empty( $settings['exclude'] ) ) {
			if ( in_array( 'current_post', $settings['exclude'] ) ) {
				if ( gugurUtils::is_ajax() && ! empty( $_REQUEST['post_id'] ) ) {
