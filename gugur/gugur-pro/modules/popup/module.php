...
class Module extends Module_Base {
	...
	public function __construct() {
		...
		add_filter( 'gugur_pro/query_control/get_autocomplete/popup_templates', [ $this, 'get_autocomplete_for_popup_templates' ], 10, 2 );
		add_filter( 'gugur_pro/query_control/get_value_titles/popup_templates', [ $this, 'get_titles_for_popup_templates' ], 10, 2 );
	...
	/**
	 * @param \gugurPro\Modules\ThemeBuilder\Classes\Locations_Manager $location_manager
	 */
	...
	/**
	 * @param \gugur\Core\DynamicTags\Manager $dynamic_tags
	 */
	...
	public function get_titles_for_popup_templates( array $results, array $data ) {
		$document = Plugin::gugur()->documents->get( $data['id'] );
	...
	public function admin_menu() {
		add_submenu_page( Source_Local::ADMIN_MENU_SLUG, '', __( 'Popups', 'gugur-pro' ), 'publish_posts', $this->get_admin_url() );
	}
