	...
	public function register_pagination_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'' => __( 'None', 'gugur-pro' ),
					'numbers' => __( 'Numbers', 'gugur-pro' ),
					'prev_next' => __( 'Previous/Next', 'gugur-pro' ),
					'numbers_and_prev_next' => __( 'Numbers', 'gugur-pro' ) . ' + ' . __( 'Previous/Next', 'gugur-pro' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( '&laquo; Previous', 'gugur-pro' ),
				'condition' => [
					'pagination_type' => [
						'prev_next',
						'numbers_and_prev_next',
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Next &raquo;', 'gugur-pro' ),
				'condition' => [
					'pagination_type' => [
						'prev_next',
						'numbers_and_prev_next',
		...
		$this->add_control(
			...
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .gugur-pagination' => 'text-align: {{VALUE}};',
				],
				'condition' => [
					'pagination_type!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .gugur-pagination',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-pagination .page-numbers:not(.dots)' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .gugur-pagination a.page-numbers:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .gugur-pagination .page-numbers.current' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'body:not(.rtl) {{WRAPPER}} .gugur-pagination .page-numbers:not(:first-child)' => 'margin-left: calc( {{SIZE}}{{UNIT}}/2 );',
					'body:not(.rtl) {{WRAPPER}} .gugur-pagination .page-numbers:not(:last-child)' => 'margin-right: calc( {{SIZE}}{{UNIT}}/2 );',
					'body.rtl {{WRAPPER}} .gugur-pagination .page-numbers:not(:first-child)' => 'margin-right: calc( {{SIZE}}{{UNIT}}/2 );',
					'body.rtl {{WRAPPER}} .gugur-pagination .page-numbers:not(:last-child)' => 'margin-left: calc( {{SIZE}}{{UNIT}}/2 );',
				],
			]
		);
