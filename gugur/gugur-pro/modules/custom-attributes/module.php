<?php
namespace gugurPro\Modules\CustomAttributes;
...
class Module extends Module_Base {
	...
	private function get_black_list_attributes() {
		...
		if ( null === $black_list ) {
			...
			/**
			 * gugur attributes black list.
			 *
			 * Filters the attributes that won't be rendered in the wrapper element.
			 *
			 * By default gugur don't render some attributes to prevent things
			 ...
			 */
			$black_list = apply_filters( 'gugur_pro/element/attributes/black_list', $black_list );
		}
	...
	public function register_controls( Controls_Stack $element, $section_id ) {
		...
		$element->add_control(
			'_attributes',
			[
				'label' => __( 'Custom Attributes', 'gugur-pro' ),
				'type' => Controls_Manager::TEXTAREA,
				'placeholder' => __( 'key|value', 'gugur-pro' ),
				'description' => sprintf( __( 'Set custom attributes for the wrapper element. Each attribute in a separate line. Separate attribute key from the value using %s character.', 'gugur-pro' ), '<code>|</code>' ),
	...
	protected function add_actions() {
		...
		add_action( 'gugur/element/after_add_attributes', [ $this, 'render_attributes' ] );
	}
}
