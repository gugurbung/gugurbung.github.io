...
class Module extends Module_Base {
	...
	private static function render_cart_content( $cart_items, $sub_total ) {
		...
		<div class="gugur-menu-cart__footer-buttons">
			<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="gugur-button gugur-button--view-cart gugur-size-md">
				<span class="gugur-button-text"><?php echo translate( 'View cart', 'woocommerce' ); ?></span>
			</a>
			<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="gugur-button gugur-button--checkout gugur-size-md">
				<span class="gugur-button-text"><?php echo translate( 'Checkout', 'woocommerce' ); ?></span>
			</a>
		</div>
		<?php
	}
	...
	public static function render_menu_cart() {
		...
		$toggle_button_classes = 'gugur-button gugur-size-sm';
		$toggle_button_classes .= $widget_cart_is_hidden ? ' gugur-menu-cart-hidden' : '';
		...
		<div class="gugur-menu-cart__wrapper">
			...
			<div class="gugur-menu-cart__container gugur-lightbox">
				<form class="gugur-menu-cart__main woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	public function menu_cart_fragments( $fragments ) {
		...
		if ( ! empty( $menu_cart_html ) ) {
			$fragments['body:not(.gugur-editor-active) div.gugur-element.gugur-widget.gugur-widget-woocommerce-menu-cart div.gugur-menu-cart__wrapper'] = $menu_cart_html;
		}
