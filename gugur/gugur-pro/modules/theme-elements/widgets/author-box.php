...
class Author_Box extends Base {
	...
	public function get_title() {
		return __( 'Author Box', 'gugur-pro' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_author_info',
			[
				'label' => __( 'Author Info', 'gugur-pro' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'current',
				'options' => [
					'current' => __( 'Current Author', 'gugur-pro' ),
		...
		$this->add_control(
			'show_avatar',
			[
				'label' => __( 'Profile Picture', 'gugur-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'prefix_class' => 'gugur-author-box--avatar-',
		...
		$this->add_control(
			'show_name',
			[
				'label' => __( 'Display Name', 'gugur-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'prefix_class' => 'gugur-author-box--name-',
				'label_on' => __( 'Show', 'gugur-pro' ),
				'label_off' => __( 'Hide', 'gugur-pro' ),
				'default' => 'yes',
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'' => __( 'None', 'gugur-pro' ),
					'website' => __( 'Website', 'gugur-pro' ),
					'posts_archive' => __( 'Posts Archive', 'gugur-pro' ),
				],
				'condition' => [
					'source!' => 'custom',
				],
				'description' => __( 'Link for the Author Name and Image', 'gugur-pro' ),
			]
		);
		...
		$this->add_control(
			'show_biography',
			[
				'label' => __( 'Biography', 'gugur-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'prefix_class' => 'gugur-author-box--biography-',
				'label_on' => __( 'Show', 'gugur-pro' ),
				'label_off' => __( 'Hide', 'gugur-pro' ),
				'default' => 'yes',
				'condition' => [
		...
		$this->add_control(
			'show_link',
			[
				'label' => __( 'Archive Button', 'gugur-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'prefix_class' => 'gugur-author-box--link-',
				'label_on' => __( 'Show', 'gugur-pro' ),
				'label_off' => __( 'Hide', 'gugur-pro' ),
				'default' => 'no',
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'gugur-pro' ),
				'rows' => 4,
				'condition' => [
					'source' => 'custom',
				],
		...
		$this->add_control(
			'link_text',
			[
				'label' => __( 'Archive Text', 'gugur-pro' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'All Posts', 'gugur-pro' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'prefix_class' => 'gugur-author-box--layout-image-',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'gugur-author-box--align-',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'gugur-author-box--image-valign-',
				'condition' => [
					'layout!' => 'above',
				],
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__avatar img' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'body.rtl {{WRAPPER}}.gugur-author-box--layout-image-left .gugur-author-box__avatar, 
					 body:not(.rtl) {{WRAPPER}}:not(.gugur-author-box--layout-image-above) .gugur-author-box__avatar' => 'margin-right: {{SIZE}}{{UNIT}}; margin-left: 0;',

					'body:not(.rtl) {{WRAPPER}}.gugur-author-box--layout-image-right .gugur-author-box__avatar, 
					 body.rtl {{WRAPPER}}:not(.gugur-author-box--layout-image-above) .gugur-author-box__avatar' => 'margin-left: {{SIZE}}{{UNIT}}; margin-right:0;',

					'{{WRAPPER}}.gugur-author-box--layout-image-above .gugur-author-box__avatar' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SWITCHER,
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__avatar img' => 'border-style: solid',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#000',
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__avatar img' => 'border-color: {{VALUE}}',
				],
				'condition' => [
					'image_border' => 'yes',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__avatar img' => 'border-width: {{SIZE}}{{UNIT}}',
				],
				'condition' => [
					'image_border' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__avatar img' => 'border-radius: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .gugur-author-box__avatar img',
				'fields_options' => [
					'box_shadow_type' => [
						'separator' => 'default',
					],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__name' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .gugur-author-box__name',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__name' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__bio' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'bio_typography',
				'selector' => '{{WRAPPER}} .gugur-author-box__bio',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__bio' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__button' => 'color: {{VALUE}}; border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__button' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .gugur-author-box__button',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__button:hover' => 'border-color: {{VALUE}}; color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__button:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__button' => 'border-width: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'before',
				'condition' => [
					'link_text!' => '',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__button' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'after',
				'condition' => [
					'link_text!' => '',
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .gugur-author-box__button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
	...
	protected function render() {
		...
		if ( $print_link && ! empty( $settings['button_hover_animation'] ) ) {
			$this->add_render_attribute(
				'button',
				'class',
				'gugur-animation-' . $settings['button_hover_animation']
			);
		}
		...
		?>
		<div class="gugur-author-box">
			<?php if ( $print_avatar ) { ?>
				<<?php echo $link_tag; ?> <?php echo $this->get_render_attribute_string( 'author_link' ); ?> class="gugur-author-box__avatar">
					<img <?php echo $this->get_render_attribute_string( 'avatar' ); ?>>
				</<?php echo $link_tag; ?>>
			<?php } ?>

			<div class="gugur-author-box__text">
				<?php if ( $print_name ) : ?>
					<<?php echo $link_tag; ?> <?php echo $this->get_render_attribute_string( 'author_link' ); ?>>
						<?php echo '<' . $author_name_tag . ' class="gugur-author-box__name">' . $author['display_name'] . '</' . $author_name_tag . '>'; ?>
					</<?php echo $link_tag; ?>>
				<?php endif; ?>

				<?php if ( $print_bio ) : ?>
					<div class="gugur-author-box__bio">
						<?php echo $author['bio']; ?>
					</div>
				<?php endif; ?>
