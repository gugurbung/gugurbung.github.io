...
class API {
	...
	const STORE_URL = 'http://my.gugur.com/api/v1/licenses/';
	...
	public static function activate_license( $license_key ) {
		return array('success'=>true, 'license'=>'valid', 'item_name'=>'gugur Pro', 'license_limit'=>999, 'site_count'=>1, 'expires'=>'2048-06-06 23:59:59', 'activations_left'=>998, 'payment_id'=>'12345',
'customer_name'=>'nulledforums.to', 'customer_email'=>'ShadowNF@tuta.io', 'price_id'=>'1');
	...
	public static function deactivate_license() {
		return array('success'=>true, 'license'=>'deactivated', 'item_name'=>'gugur Pro', 'license_limit'=>999, 'site_count'=>1, 'expires'=>'2048-06-06 23:59:59', 'activations_left'=>998, 'payment_id'=>'12345',
'customer_name'=>'nulledforums.to', 'customer_email'=>'ShadowNF@tuta.io', 'price_id'=>'1');
		$body_args = [
	...
	public static function get_previous_package_url() {
		$url = 'http://my.gugur.com/api/v1/pro-downloads/';
