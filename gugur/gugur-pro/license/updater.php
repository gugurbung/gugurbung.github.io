...
class Updater {
	...
	public function __construct() {
		$this->plugin_version = gugur_PRO_VERSION;
		$this->plugin_name = gugur_PRO_PLUGIN_BASE;
		$this->plugin_slug = basename( gugur_PRO__FILE__, '.php' );
	...
	public function plugins_api_filter( $_data, $_action = '', $_args = null ) {
		...
		$cache_key = 'gugur_pro_api_request_' . substr( md5( serialize( $this->plugin_slug ) ), 0, 15 );
		...
		if ( empty( $api_request_transient ) ) {
			...
			$api_request_transient->name = 'gugur Pro';
			$api_request_transient->slug = $this->plugin_slug;
			$api_request_transient->author = '<a href="https://gugur.com/">gugur.com</a>';
			$api_request_transient->homepage = 'https://gugur.com/';
			...
			$api_request_transient->banners = [
				'high' => 'https://ps.w.org/gugur/assets/banner-1544x500.png?rev=1494133',
				'low' => 'https://ps.w.org/gugur/assets/banner-1544x500.png?rev=1494133',
			];
