...
class Plugin {
	...
	private function includes() {
		...
		if ( is_admin() ) {
			require gugur_PRO_PATH . 'includes/admin.php';
		}
	}
	...
	public function enqueue_editor_scripts() {
		...
		wp_enqueue_script(
			'gugur-pro',
			gugur_PRO_URL . 'assets/js/editor' . $suffix . '.js',
			[
				'backbone-marionette',
		 ...
		 * @param array $locale_settings Localized settings.
		 */
		$locale_settings = apply_filters( 'gugur_pro/editor/localize_settings', $locale_settings );
	...
	public function enqueue_editor_styles() {
		...
		wp_enqueue_style(
			'gugur-pro',
			gugur_PRO_URL . 'assets/css/editor' . $direction_suffix . $suffix . '.css',
			[
				'gugur-editor',
			],
			gugur_PRO_VERSION
	...
	public function on_gugur_editor_init() {
		self::gugur()->common->add_template( __DIR__ . '/includes/templates/editor.php' );
	}
