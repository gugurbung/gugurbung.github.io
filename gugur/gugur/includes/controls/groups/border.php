...
class Group_Control_Border extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['border'] = [
			'label' => _x( 'Border Type', 'Border Control', 'gugur' ),
			'type' => Controls_Manager::SELECT,
			'options' => [
				'' => __( 'None', 'gugur' ),
				'solid' => _x( 'Solid', 'Border Control', 'gugur' ),
				'double' => _x( 'Double', 'Border Control', 'gugur' ),
				'dotted' => _x( 'Dotted', 'Border Control', 'gugur' ),
				'dashed' => _x( 'Dashed', 'Border Control', 'gugur' ),
				'groove' => _x( 'Groove', 'Border Control', 'gugur' ),
			],
			'selectors' => [
		...
		$fields['width'] = [
			'label' => _x( 'Width', 'Border Control', 'gugur' ),
		...
		$fields['color'] = [
			'label' => _x( 'Color', 'Border Control', 'gugur' ),
