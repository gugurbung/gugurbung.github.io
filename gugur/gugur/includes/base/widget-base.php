 ...
 * gugur widget base.
 *
 * An abstract class to register new gugur widgets. It extended the
...
abstract class Widget_Base extends Element_Base {
	 ...
	 * posts widget in gugur Pro. Default is true, the widget has content
	 * template.
	 *
	 * @access protected
	 *
	...
	public function __construct( $data = [], $args = null ) {
		...
		if ( $is_type_instance ) {
			 ...
			 * Widget skin init.
			 *
			 * Fires when gugur widget is being initialized.
			 *
			 ...
			 */
			do_action( "gugur/widget/{$widget_name}/skins_init", $this );
		}
	}
	...
	protected function print_template_content( $template_content ) {
		?>
		<div class="gugur-widget-container">
			<?php
	...
	protected function get_html_wrapper_class() {
		return 'gugur-widget-' . $this->get_name();
	}
	...
	public function render_content() {
		 ...
		 *
		 * Fires before gugur widget is being rendered.
		 *
		 * @since 1.0.0
		 *
		 * @param Widget_Base $this The current widget.
		 */
		do_action( 'gugur/widget/before_render_content', $this );
		...
		<div class="gugur-widget-container">
			 ...
			 */
			$widget_content = apply_filters( 'gugur/widget/render_content', $widget_content, $this );
	 ...
	 *
	 * gugur saves the page content in a unique way, but it's not the way
	 ...
	 * also allows the site to keep working even if gugur is deactivated.
	 *
	 ...
	 * an empty string. For example gugur Pro Form Widget uses this method
	 * to return an empty string because there is no content to return. This way
	 * if gugur Pro will be deactivated there won't be any form to display.
	 *
	 * @since 1.0.0
	 * @access public
	 */
