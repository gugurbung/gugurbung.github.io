 ...
 * gugur audio widget.
 *
 * gugur widget that displays an audio player.
 *
 * @since 1.0.0
 */
class Widget_Audio extends Widget_Base {
	...
	protected function render() {
		...
		if ( $video_html ) : ?>
			<div class="gugur-soundcloud-wrapper">
				<?php echo $video_html; ?>
			</div>
			<?php
		endif;
