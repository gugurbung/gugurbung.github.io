...
/**
 * gugur divider widget.
 *
 * gugur widget that displays a line that divides different elements in the
 * page.
 *
 * @since 1.0.0
 */
class Widget_Divider extends Widget_Base {
	...
	private static function get_additional_styles() {
		 ...
		 * Additional Styles.
		 *
		 * Filters the styles used by gugur to add additional divider styles.
		 *
		 * @since 2.7.0
		 *
		 * @param array $additional_styles Additional gugur divider styles.
		 */
		$additional_styles = apply_filters( 'gugur/divider/styles/additional_styles', $additional_styles );
		return $additional_styles;
	}
	...
	private function get_separator_styles() {
		return array_merge(
			...
			[
				...
				'multiple'   => [
					'label' => _x( 'Multiple', 'shapes', 'gugur' ),
				...
				'parallelogram'   => [
					'label' => _x( 'Parallelogram', 'shapes', 'gugur' ),
				...
				'rectangles'   => [
					'label' => _x( 'Rectangles', 'shapes', 'gugur' ),
				...
				'trees_2_tribal'   => [
					'label' => _x( 'Fir Tree', 'shapes', 'gugur' ),
				...
				'rounds_tribal'   => [
					'label' => _x( 'Half Rounds', 'shapes', 'gugur' ),
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'pattern',
				'prefix_class' => 'gugur-widget-divider--separator-type-',
				'condition' => [
					'style!' => [
						'',
						'solid',
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HIDDEN,
				'default' => 'no-spacing',
				'prefix_class' => 'gugur-widget-divider--',
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-divider-separator' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-divider' => 'text-align: {{VALUE}}',
					'{{WRAPPER}} .gugur-divider-separator' => 'margin: 0 auto; margin-{{VALUE}}: 0',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'prefix_class' => 'gugur-widget-divider--view-',
				'render_type' => 'template',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-divider' => 'padding-top: {{SIZE}}{{UNIT}}; padding-bottom: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-divider__text' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .gugur-divider__text',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'center',
				'prefix_class' => 'gugur-widget-divider--element-align-',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .gugur-icon' => 'border-radius: {{SIZE}}{{UNIT}}',
				],
				'condition' => [
					'icon_view!' => 'default',
				],
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'gugur-divider' );
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			<span class="gugur-divider-separator">
			<?php if ( $has_icon ) : ?>
				<div class="gugur-icon gugur-divider__element">
					<?php
			...
			<?php elseif ( $has_text ) :
				...
				$this->add_render_attribute( 'text', [ 'class' => [ 'gugur-divider__text', 'gugur-divider__element' ] ] );
				?>
