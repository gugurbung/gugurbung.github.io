...
/**
 * gugur icon box widget.
 *
 * gugur widget that displays an icon, a headline and a text.
 *
 * @since 1.0.0
 */
class Widget_Icon_Box extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.gugur-view-framed .gugur-icon, {{WRAPPER}}.gugur-view-default .gugur-icon' => 'fill: {{VALUE}}; color: {{VALUE}}; border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.gugur-view-stacked .gugur-icon' => 'fill: {{VALUE}}; color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.gugur-view-framed .gugur-icon:hover, {{WRAPPER}}.gugur-view-default .gugur-icon:hover' => 'fill: {{VALUE}}; color: {{VALUE}}; border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.gugur-view-stacked .gugur-icon:hover' => 'fill: {{VALUE}}; color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.gugur-position-right .gugur-icon-box-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.gugur-position-left .gugur-icon-box-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.gugur-position-top .gugur-icon-box-icon' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'(mobile){{WRAPPER}} .gugur-icon-box-icon' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-icon-box-wrapper' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-icon-box-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .gugur-icon-box-content .gugur-icon-box-title' => 'color: {{VALUE}};',
				],
				'scheme' => [
					'type' => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .gugur-icon-box-content .gugur-icon-box-title',
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .gugur-icon-box-content .gugur-icon-box-description' => 'color: {{VALUE}};',
				],
				'scheme' => [
					'type' => Scheme_Color::get_type(),
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .gugur-icon-box-content .gugur-icon-box-description',
	...
	protected function render() {
		...
		$this->add_render_attribute( 'icon', 'class', [ 'gugur-icon', 'gugur-animation-' . $settings['hover_animation'] ] );
		...
		$this->add_render_attribute( 'description_text', 'class', 'gugur-icon-box-description' );
		...
		?>
		<div class="gugur-icon-box-wrapper">
			<?php if ( $has_icon ) : ?>
			<div class="gugur-icon-box-icon">
			...
			<?php endif; ?>
			<div class="gugur-icon-box-content">
				<<?php echo $settings['title_size']; ?> class="gugur-icon-box-title">
	...
	protected function _content_template() {
		...
		view.addRenderAttribute( 'description_text', 'class', 'gugur-icon-box-description' );
		...
		<div class="gugur-icon-box-wrapper">
			...
			<div class="gugur-icon-box-icon">
				<{{{ iconTag + ' ' + link }}} class="gugur-icon gugur-animation-{{ settings.hover_animation }}">
			...
			<# } #>
			<div class="gugur-icon-box-content">
				<{{{ settings.title_size }}} class="gugur-icon-box-title">
