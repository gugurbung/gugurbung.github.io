 ...
 * gugur fonts.
 *
 * gugur fonts handler class is responsible for registering the supported
 * fonts used by gugur.
 *
 * @since 1.0.0
 */
class Fonts {
	...
	public static function get_font_groups() {
		if ( null === self::$font_groups ) {
			$font_groups = [
				self::SYSTEM => __( 'System', 'gugur' ),
				self::GOOGLE => __( 'Google', 'gugur' ),
				self::EARLYACCESS => __( 'Google Early Access', 'gugur' ),
			];

			/**
			 * Font groups.
			 *
			 * Filters the fonts groups used by gugur.
			 *
			 * @since 1.9.4
			 *
			 * @param array $font_groups Font groups.
			 */
			$font_groups = apply_filters( 'gugur/fonts/groups', $font_groups );
	...
	public static function get_fonts() {
		if ( null === self::$fonts ) {
			 ...
			 * Additional fonts.
			 *
			 * Filters the fonts used by gugur to add additional fonts.
			 *
			 * @since 1.9.4
			 *
			 * @param array $additional_fonts Additional gugur fonts.
			 */
			$additional_fonts = apply_filters( 'gugur/fonts/additional_fonts', $additional_fonts );
