<?php
namespace gugur\Core\Responsive;
 ...
 * gugur responsive.
 *
 * gugur responsive handler class is responsible for setting up gugur
...
class Responsive {
	...
	/**
	 * The gugur breakpoint prefix.
	 */
	const BREAKPOINT_OPTION_PREFIX = 'gugur_viewport_';
	...
	public static function get_stylesheet_templates_path() {
		return gugur_ASSETS_PATH . 'css/templates/';
	}
	...
	private static function get_stylesheet_templates() {
		...
		return apply_filters( 'gugur/core/responsive/get_stylesheet_templates', $templates );
	}
}
