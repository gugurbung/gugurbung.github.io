...
class Manager {
	 ...
	 *
	 * Initializing gugur dynamic tags manager.
	 *
	 * @since 2.0.0
	 * @access public
	 */
	...
	public function get_tags() {
		if ( ! did_action( 'gugur/dynamic_tags/register_tags' ) ) {
			/**
			 * Register dynamic tags.
			 *
			 * Fires when gugur registers dynamic tags.
			 *
			 * @since 2.0.9
			 *
			 * @param Manager $this Dynamic tags manager.
			 */
			do_action( 'gugur/dynamic_tags/register_tags', $this );
		}
	...
	public function ajax_render_tags( $data ) {
		 ...
		 *
		 * Fires before gugur renders the dynamic tags.
		 *
		 * @since 2.0.0
		 */
		do_action( 'gugur/dynamic_tags/before_render' );
		 ...
		 *
		 * Fires after gugur renders the dynamic tags.
		 *
		 * @since 2.0.0
		 */
		do_action( 'gugur/dynamic_tags/after_render' );
	...
	private function add_actions() {
		...
		add_action( 'gugur/css-file/post/enqueue', [ $this, 'after_enqueue_post_css' ] );
	}
}
