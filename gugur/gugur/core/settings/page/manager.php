...
/**
 * gugur page settings manager.
 *
 * gugur page settings manager handler class is responsible for registering
 * and managing gugur page settings managers.
 *
 * @since 1.6.0
 */
class Manager extends BaseManager {
	 ...
	 */
	const META_KEY = '_gugur_page_settings';
