...
class Htaccess extends Inspection_Base {
	...
	public function __construct() {
		$this->message = __( 'Your site\'s .htaccess file appears to be missing.', 'gugur' );
	}
	...
	public function run() {
		...
		if ( strstr( $server, 'APACHE' ) ) {
			...
			$this->message .= ' ' . sprintf( __( 'File Path: %s', 'gugur' ), $htaccess_file ) . ' ';
	...
	public function get_help_doc_url() {
		return 'https://go.gugur.com/preview-not-loaded/#htaccess';
	}
}
