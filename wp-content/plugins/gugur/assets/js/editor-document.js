...
function (_gugurModules$Mod) {
  (0, _inherits2.default)(BaseComponent, _gugurModules$Mod);
  ...
  (0, _createClass2.default)(BaseComponent, [{
    ...
    value: function getNamespace() {
      gugurModules.ForceMethodImplementation();
    }
  }, {
    ...
    value: function onRoute(route) {
      gugurCommon.elements.$body.addClass(this.getBodyClass(route));
      this.activate();
    ...
    value: function onCloseRoute(route) {
      gugurCommon.elements.$body.removeClass(this.getBodyClass(route));
      this.inactivate();
    ...
    value: function activateTab(tab) {
      ...
      this.currentTab = tab;
      this.renderTab(tab);
      jQuery(this.getTabsWrapperSelector() + ' .gugur-component-tab').off('click').on('click', function (event) {
        $e.route(_this4.getTabRoute(event.currentTarget.dataset.tab));
      }).removeClass('gugur-active').filter('[data-tab="' + tab + '"]').addClass('gugur-active');
    }
  }, {
    key: "getBodyClass",
...
function (_Base) {
  ...
  (0, _createClass2.default)(History, [{
     ...
     *
     * Return `gugur.history.history.getActive()`.
     *
     * @returns {boolean}
     */
    ...
    value: function onCatchApply(e) {
      ...
      if (e instanceof gugurModules.common.HookBreak && this.historyId) {
...
function (_ArgsObject) {
  ...
  /**
   * Current component (gugurModules.Module ).
   *
   * @type {{}}
   */
  ...
  (0, _createClass2.default)(Base, [{
    ...
    value: function requireContainer() {
      ...
      containers.forEach(function (container) {
        _this2.requireArgumentInstance('container', gugurModules.editor.Container, {
          container: container
        });
      });
    }
    ...
    value: function run() {
      ...
      try {
        ...
        if (e instanceof gugurModules.common.HookBreak) {
          return false;
        }
      } // For $e.hooks.
...
function () {
  ...
  (0, _createClass2.default)(Helpers, null, [{
    ...
    value: function findViewById(id) {
      var elements = Helpers.findViewRecursive(gugur.getPreviewView().children, 'id', id, false);
    ...
    value: function isValidChild(childModel, parentModel) {
      ...
      var childTypes = gugur.helpers.getElementChildType(parentElType);
    ...
    value: function isPasteEnabled(targetContainer) {
      var storage = gugurCommon.storage.get('clipboard'); // No storage? no paste.
  ...
  (0, _createClass2.default)(Create, [{
    ...
    value: function getHistory(args) {
      ...
      return {
        ...
        model: model,
        type: 'add',
        title: gugur.helpers.getModelLabel(model)
      };
    }
  }, {
    key: "apply",
...
var getDefaultDebounceDelay = function getDefaultDebounceDelay() {
  ...
  if (gugurConfig.document && undefined !== gugurConfig.document.debounceDelay) {
    result = gugurConfig.document.debounceDelay;
  }
...
function (_History) {
  ...
  (0, _createClass2.default)(Debounce, [{
    ...
    value: function onCatchApply(e) {
      ...
      if (e instanceof gugurModules.common.HookBreak && this.history) {
        if (this.isDebounceRequired) {
...
function (_History) {
  ...
  (0, _createClass2.default)(DisableEnable, [{
    ...
    value: function getHistory(args) {
      ...
      var subTitle = gugur.translate('dynamic') + ' ' + _settings.default.getSubTitle(args),
          type = this.type;
  ...
  (0, _createClass2.default)(Copy, [{
    ...
    value: function apply(args) {
      var _args$storageKey = args.storageKey,
          ...
          _args$containers = args.containers,
          containers = _args$containers === void 0 ? [args.container] : _args$containers;
      gugurCommon.storage.set(storageKey, containers.map(function (container) {
  ...
  (0, _createClass2.default)(CopyAll, [{
    ...
    value: function apply() {
      $e.run('document/elements/copy', {
        containers: (0, _values.default)(gugur.getPreviewView().children._views).map(function (view) {
  ...
  (0, _createClass2.default)(Delete, [{
    ...
    value: function apply(args) {
      ...
      containers.forEach(function (container) {
        ...
        gugur.channels.data.trigger('element:before:remove', container.model);
        container.model.destroy(); // BC: Deprecated since 2.8.0 - use `$e.events`.

        gugur.channels.data.trigger('element:after:remove', container.model);
        container.panel.refresh();
      });
...
function (_History) {
  ...
  (0, _createClass2.default)(Empty, [{
    ...
    value: function getHistory(args) {
      if (args.force) {
        return {
          ...
          data: gugur.elements ? gugur.elements.toJSON() : null,
          restore: this.constructor.restore
        };
      }
    ...
    key: "apply",
    value: function apply(args) {
      if (args.force && gugur.elements) {
        gugur.elements.reset();
        gugur.getPreviewContainer().panel.closeEditor();
        return;
      }

      gugur.getClearPageDialog().show();
    }
  }, {
    key: "isDataChanged",
    value: function isDataChanged() {
    ...
    value: function restore(historyItem, isRedo) {
      if (isRedo) {
        ...
        if (data) {
          gugur.getPreviewView().addChildModel(data);
        }
      }
    }
  }]);
...
function (_History) {
  ...
  (0, _createClass2.default)(Import, [{
    ...
    key: "apply",
    value: function apply(args) {
      var previewContainer = gugur.getPreviewContainer(),
          data = args.data,
          _args$options = args.options,
      ...
      (0, _entries.default)(data.content).forEach(function (_ref) {
        ...
        $e.run('document/elements/create', {
          container: gugur.getPreviewContainer(),
          model: model,
...
function (_History) {
  ...
  (0, _createClass2.default)(Paste, [{
    ...
    value: function validateArgs(args) {
      ...
      var _args$storageKey = args.storageKey,
          storageKey = _args$storageKey === void 0 ? 'clipboard' : _args$storageKey,
          storageData = gugurCommon.storage.get(storageKey);
...
function (_History) {
  ...
  (0, _createClass2.default)(Move, [{
    ...
    value: function validateArgs(args) {
      this.requireContainer(args);
      this.requireArgumentInstance('target', gugurModules.editor.Container, args);
    }
  }, {
    key: "getHistory",
    value: function getHistory(args) {
      ...
      containers.forEach(function (targetContainer) {
        ...
        storageData.forEach(function (sourceModel) {
          ...
          (0, _entries.default)(targetControls).forEach(function (_ref) {
            ...
            if (controlSourceValue === controlTargetValue || !gugur.getControlView(control.type).onPasteStyle(control, controlSourceValue)) {
              return;
            }
          ...
          gugur.channels.data.trigger('element:before:paste:style', targetContainer.model);
          $e.run('document/elements/settings', {
            container: targetContainer,
          ...
          gugur.channels.data.trigger('element:after:paste:style', targetContainer.model);
  ...
  (0, _createClass2.default)(ResetStyle, [{
    ...
    value: function apply(args) {
      ...
      containers.forEach(function (container) {
        ...
        gugur.channels.data.trigger('element:before:reset:style', container.model);
        $e.run('document/elements/settings', {
          container: container,
          settings: defaultValues
        }); // BC: Deprecated since 2.8.0 - use `$e.events`.

        gugur.channels.data.trigger('element:after:reset:style', container.model);
...
gugurCommon.elements.$window.on('gugur:init', function () {
...
function () {
  function BackwardsCompatibility() {
    ...
    gugurCommon.elements.$window.on('gugur:init', this.deprecatedEvents);
    gugur.channels.data.on('template:before:insert', this.startInsertTemplate).on('template:after:insert', this.endItem);
  }

  (0, _createClass2.default)(BackwardsCompatibility, [{
    key: "deprecatedEvents",
    value: function deprecatedEvents() {
      var gugurDataEvents = gugur.channels.data._events,
      ...
      deprecatedEvents.forEach(function (event) {
        if (gugurDataEvents[event] && gugurDataEvents[event].length) {
          gugurCommon.helpers.softDeprecated("event: ".concat(event), '2.8.0', '$e.events');
        }
      });
    }
  }, {
    ...
    value: function startInsertTemplate(model) {
      gugurCommon.helpers.softDeprecated('event: template:before:insert', '2.8.0', "$e.run( 'document/import' )");
...
function (_HookDependency) {
  ...
  (0, _createClass2.default)(IsPasteStyleEnabled, [{
    ...
    key: "apply",
    value: function apply() {
      return gugur.getCurrentElement().pasteStyle && gugurCommon.storage.get('clipboard');
    }
  }]);
    ...
    value: function apply(args) {
      ...
      container) {
        if ('dynamic' === container.type) {
          var tagText = gugur.dynamicTags.tagContainerToTagText(container),
              commandArgs = {
  ...
  (0, _createClass2.default)(ResizeColumn, [{
    ...
    value: function resizeColumn(container, newSize) {
      ...
      var parentView = container.parent.view,
          ...
          totalWidth = parentView.$el.find(' > .gugur-container')[0].getBoundingClientRect().width;
      ...
      $e.run('document/elements/settings', {
        ...
        options: {
          ...
          history: {
            title: gugur.config.elements.column.controls._inline_size.label
          },
          external: true,
          debounce: true
        }
...
function (_Base) {
  ...
  (0, _createClass2.default)(Copy, [{
    key: "apply",
    value: function apply(args) {
      var selectedElement = gugur.getCurrentElement();
...
function (_Base) {
  ...
  (0, _createClass2.default)(Paste, [{
    ...
    value: function initialize(args) {
      ...
      this.storage = gugurCommon.storage.get('clipboard');
      this.storage = this.storage.map(function (model) {
        return new Backbone.Model(model);
      });

      if (!containers[0]) {
        this.target = gugur.getCurrentElement();
...
function (_History) {
  ...
  (0, _createClass2.default)(Insert, [{
    ...
    value: function initialize(args) {
      ...
      if (!args.model._id) {
        args.model._id = gugur.helpers.getUniqueID();
      }
    }
  }, {
    key: "validateArgs",
...
function (_History) {
  ...
  (0, _createClass2.default)(Move, [{
    ...
    value: function apply(args) {
      ...
      containers.forEach(function (container) {
        var collection = container.settings.get(name),
            model = gugurCommon.helpers.cloneObject(collection.at(sourceIndex));
        $e.run('document/repeater/remove', {
          container: container,
          name: name,
          index: sourceIndex
  ...
  (0, _createClass2.default)(Component, [{
    ...
    value: function getCommands() {
      return {
        ...
        undo: function undo() {
          return gugur.history.history.navigate();
        },
        redo: function redo() {
          return gugur.history.history.navigate(true);
        }
      };
    }
  }, {
    ...
    value: function normalizeLogTitle(args) {
      ...
      if (!args.title && containers[0]) {
        if (1 === containers.length) {
          ...
          args.title = gugur.translate('elements');
        }
      }
...
function (_Base) {
  ...
  (0, _createClass2.default)(AddTransaction, [{
    key: "apply",
    value: function apply(args) {
      var currentId = gugur.history.history.getCurrentId();
...
function (_Base) {
  ...
  (0, _createClass2.default)(DeleteLog, [{
    ...
    value: function apply(args) {
      if (args.id) {
        gugur.history.history.deleteItem(args.id);
      }
    }
  }]);
  return DeleteLog;
...
function (_Base) {
  ...
  (0, _createClass2.default)(EndLog, [{
    ...
    value: function apply(args) {
      if (args.id) {
        gugur.history.history.endItem(args.id);
      }
    }
  }]);
  return EndLog;
...
function (_Base) {
  ...
  (0, _createClass2.default)(LogSubItem, [{
    ...
    value: function apply(args) {
      ...
      var id = args.id || gugur.history.history.getCurrentId();
      args = this.component.normalizeLogTitle(args);
      var items = gugur.history.history.getItems(),
...
function (_Base) {
  ...
  (0, _createClass2.default)(StartLog, [{
    key: "initialize",
    value: function initialize(args) {
      if (gugur.history.history.isItemStarted() || args.id) {
        this.isSubItem = true;
        return;
      }
    ...
    value: function apply(args) {
      ...
      return gugur.history.history.startItem(args);
    }
  }]);
  return StartLog;
}(_base.default);
