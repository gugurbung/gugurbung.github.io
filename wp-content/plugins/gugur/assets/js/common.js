...
var _item = _interopRequireDefault(__webpack_require__(463));

var _itemModel = _interopRequireDefault(__webpack_require__(464));
...
function (_Marionette$Composite) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function className() {
      return 'gugur-finder__results__category';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-gugur-finder__results__category';
    }
  }, {
    key: "getChildView",
    ...
    value: function initialize() {
      this.childViewContainer = '.gugur-finder__results__category__items';
      this.isVisible = true;
    ...
    value: function getTextFilter() {
      return gugurCommon.finder.channel.request('filter:text').trim().toLowerCase();
    }
  }, {
    key: "toggleElement",
    ...
    value: function onRender() {
      this.listenTo(gugurCommon.finder.channel, 'filter:change', this.onFilterChange.bind(this));
    }
  }, {
    key: "onFilterChange",
...
var _helpers = _interopRequireDefault(__webpack_require__(456));

var _storage = _interopRequireDefault(__webpack_require__(231));

var _ajax = _interopRequireDefault(__webpack_require__(457));

var _finder = _interopRequireDefault(__webpack_require__(458));

var _connect = _interopRequireDefault(__webpack_require__(466));

var _components = _interopRequireDefault(__webpack_require__(467));

var _commands = _interopRequireDefault(__webpack_require__(265));

var _routes = _interopRequireDefault(__webpack_require__(468));

var _shortcuts = _interopRequireDefault(__webpack_require__(469));

var _backwardsCompatibility = _interopRequireDefault(__webpack_require__(470));

var gugurCommonApp =
/*#__PURE__*/
function (_gugurModules$Vie) {
  (0, _inherits2.default)(gugurCommonApp, _gugurModules$Vie);

  function gugurCommonApp() {
    (0, _classCallCheck2.default)(this, gugurCommonApp);
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(gugurCommonApp).apply(this, arguments));
  }

  (0, _createClass2.default)(gugurCommonApp, [{
    ...
    value: function onInit() {
      (0, _get2.default)((0, _getPrototypeOf2.default)(gugurCommonApp.prototype), "onInit", this).call(this);
      this.config = gugurCommonConfig;
      this.setMarionetteTemplateCompiler();
    }
  }]);
  return gugurCommonApp;
}(gugurModules.ViewModule);

window.gugurCommon = new gugurCommonApp();
gugurCommon.initComponents();
...
function () {
  ...
  (0, _createClass2.default)(Helpers, [{
    ...
    value: function deprecatedMethod(methodName, version, replacement) {
      ...
      var style = "font-size: 12px; background-image: url(\"".concat(gugurCommon.config.urls.assets, "images/logo-icon.png\"); background-repeat: no-repeat; background-size: contain;");
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function send(action, options) {
      ...
      var settings = this.getSettings(),
          ajaxParams = gugurCommon.helpers.cloneObject(settings.ajaxParams);
      options = options || {};
      action = settings.actionPrefix + action;
      jQuery.extend(ajaxParams, options);
      var requestConstants = gugurCommon.helpers.cloneObject(this.requestConstants);
...
function (_gugurModules$Mod) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "onInit",
    value: function onInit() {
      this.channel = Backbone.Radio.channel('gugur:finder');
...
var _categories = _interopRequireDefault(__webpack_require__(462));
...
function (_Marionette$LayoutVie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-gugur-finder';
    }
  }, {
    key: "ui",
    value: function ui() {
      return {
        searchInput: '#gugur-finder__search__input'
      };
    }
  }, {
    key: "events",
    ...
    value: function onSearchInputInput() {
      ...
      if (value) {
        gugurCommon.finder.channel.reply('filter:text', value).trigger('filter:change');
...
var _dynamicCategory = _interopRequireDefault(__webpack_require__(465));
...
function (_Marionette$Composite) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "id",
    value: function id() {
      return 'gugur-finder__results-container';
    }
  }, {
    key: "ui",
    value: function ui() {
      return {
        noResults: '#gugur-finder__no-results',
        categoryItem: '.gugur-finder__results__item'
      };
    }
  }, {
    key: "events",
    ...
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-gugur-finder-results-container';
    }
  }, {
    key: "getChildView",
    ...
    value: function initialize() {
      ...
      this.childViewContainer = '#gugur-finder__results';
      this.collection = new Backbone.Collection((0, _values.default)(gugurCommon.finder.getSettings('data')));
    }
  }, {
    key: "activateItem",
    value: function activateItem($item) {
      if (this.$activeItem) {
        this.$activeItem.removeClass('gugur-active');
      }

      $item.addClass('gugur-active');
...
function (_Marionette$ItemView) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "className",
    value: function className() {
      return 'gugur-finder__results__item';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-gugur-finder__results__item';
    }
  }]);
  return _default;
}(Marionette.ItemView);
...
function (_Category) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "className",
    value: function className() {
      return (0, _get2.default)((0, _getPrototypeOf2.default)(_default.prototype), "className", this).call(this) + ' gugur-finder__results__category--dynamic';
    }
  }, {
    key: "ui",
    value: function ui() {
      return {
        title: '.gugur-finder__results__category__title'
      };
    }
  }, {
    key: "fetchData",
    value: function fetchData() {
      ...
      gugurCommon.ajax.addRequest('finder_get_category_items', {
        data: {
...
function (_gugurModules$Vie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function addPopupPlugin() {
      jQuery.fn.gugurConnect = function (options) {
        ...
        gugurCommon.elements.$window.on('gugurConnected', settings.callback);
        return this;
      };
    }
  }, {
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          connectPopup: '.gugur-connect-popup'
        }
      };
    }
  }, {
    ...
    value: function applyPopup() {
      this.elements.$connectPopup.gugurConnect();
    }
  }, {
    key: "onInit",
    value: function onInit() {
    ...
    value: function handle(event) {
      ...
      jQuery.each(handlers, function (key, handler) {
        if (handler.exclude && -1 !== handler.exclude.indexOf('input')) {
          ...
          if ($target.is(':input, .gugur-input') || $target.closest('[contenteditable="true"]').length) {
            return;
          }
        }
  ...
  (0, _createClass2.default)(BackwardsCompatibility, [{
    ...
    value: function ensureTab(namespace, tabSlug) {
      ...
      if (!component) {
        ...
        /*#__PURE__*/
        function (_gugurModules$com) {
          (0, _inherits2.default)(Component, _gugurModules$com);
          ...
          (0, _createClass2.default)(Component, [{
            ...
            value: function renderTab(tab) {
              gugur.getPanelView().setPage(page).activateTab(tab);
            }
          }]);
          return Component;
      ...
      if (!component.hasTab(tabSlug) && gugur.config.tabs[tabSlug]) {
        component.addTab(tabSlug, {
          title: gugur.config.tabs[tabSlug]
        });
      }
    }
  }]);
