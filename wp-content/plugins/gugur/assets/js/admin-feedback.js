...
(function ($) {
  ...
  var gugurAdminDialogApp = {
    cacheElements: function cacheElements() {
      this.cache = {
        $deactivateLink: $('#the-list').find('[data-slug="gugur"] span.deactivate a'),
        $dialogHeader: $('#gugur-deactivate-feedback-dialog-header'),
        $dialogForm: $('#gugur-deactivate-feedback-dialog-form')
      };
    },
    ...
    initModal: function initModal() {
      ...
      self.getModal = function () {
        if (!modal) {
          modal = gugurCommon.dialogsManager.createWidget('lightbox', {
            id: 'gugur-deactivate-feedback-modal',
            ...
            onReady: function onReady() {
              ...
              this.addButton({
                name: 'submit',
                text: gugurAdmin.translate('submit_n_deactivate'),
                callback: self.sendFeedback.bind(self)
              });

              if (!gugurAdmin.config.feedback.is_tracker_opted_in) {
                this.addButton({
                  name: 'skip',
                  text: gugurAdmin.translate('skip_n_deactivate'),
            ...
            onShow: function onShow() {
              var $dialogModal = $('#gugur-deactivate-feedback-modal'),
                  radioSelector = '.gugur-deactivate-feedback-dialog-input';
    ...
    sendFeedback: function sendFeedback() {
      ...
      self.getModal().getElements('submit').text('').addClass('gugur-loading');
