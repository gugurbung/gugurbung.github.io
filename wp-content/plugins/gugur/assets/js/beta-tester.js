...
function (_gugurModules$Vie) {
  (0, _inherits2.default)(BetaTesterModule, _gugurModules$Vie);
  ...
  (0, _createClass2.default)(BetaTesterModule, [{
    ...
    value: function showLayout() {
      ...
      if (!always && (!gugurAdmin.config.beta_tester.option_enabled || gugurAdmin.config.beta_tester.signup_dismissed || '#tab-fontawesome4_migration' === location.hash)) {
        return;
      }
...
jQuery(function () {
  window.gugurBetaTester = new BetaTesterModule();
});
...
var _view = _interopRequireDefault(__webpack_require__(477));

var BetaTesterLayout =
/*#__PURE__*/
function (_gugurModules$com) {
  (0, _inherits2.default)(BetaTesterLayout, _gugurModules$com);
  ...
  (0, _createClass2.default)(BetaTesterLayout, [{
    ...
    value: function ui() {
      return {
        ...
        dontShowAgain: '.gugur-beta-tester-do-not-show-again'
      };
    }
  }, {
    key: "events",
    ...
    value: function getLogoOptions() {
      return {
        title: gugurAdmin.translate('beta_tester_sign_up')
      };
    }
  }, {
    key: "initialize",
    value: function initialize() {
      gugurModules.common.views.modal.Layout.prototype.initialize.apply(this, arguments);
      this.showLogo();
      this.showContentView();
      var doNotShowAgain = gugurAdmin.translate('do_not_show_again');
      this.modalHeader.currentView.ui.closeModal.after(jQuery('<div>', {
        class: 'gugur-beta-tester-do-not-show-again'
      }).text(doNotShowAgain));
    }
  }, {
    key: "showContentView",
    ...
    value: function onCloseModalClick() {
      gugurCommon.ajax.addRequest('introduction_viewed', {
        data: {
          introductionKey: gugurAdmin.config.beta_tester.beta_tester_signup
        }
      });
    }
  }]);
...
function (_Marionette$ItemView) {
  ...
  function BetaTesterView() {
    ...
    _this.id = 'gugur-beta-tester-dialog-content';
    _this.template = '#tmpl-gugur-beta-tester';
    return _this;
  }
  ...
  (0, _createClass2.default)(BetaTesterView, [{
    ...
    value: function ui() {
      return {
        betaForm: '#gugur-beta-tester-form',
        betaEmail: '#gugur-beta-tester-form__email',
        betaButton: '#gugur-beta-tester-form__submit'
      };
    }
  }, {
    key: "events",
    ...
    value: function onBetaFormSubmit(event) {
      ...
      this.ui.betaButton.addClass('gugur-button-state');
      gugurCommon.ajax.addRequest('beta_tester_signup', {
        data: {
          betaTesterEmail: email
        } // Do not wait for response.

      });
      gugurBetaTester.layout.hideModal();
    }
  }, {
    key: "onRender",
