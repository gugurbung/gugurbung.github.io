...
function (_gugurModules$Mod) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function get(key, options) {
      ...
      var gugurStorage = storage.getItem('gugur');

      if (gugurStorage) {
        gugurStorage = JSON.parse(gugurStorage);
      } else {
        gugurStorage = {};
      }

      if (!gugurStorage.__expiration) {
        gugurStorage.__expiration = {};
      }

      var expiration = gugurStorage.__expiration;
      ...
      expirationToCheck.forEach(function (expirationKey) {
        if (new Date(expiration[expirationKey]) < new Date()) {
          delete gugurStorage[expirationKey];
      ...
      if (entryExpired) {
        this.save(gugurStorage, options.session);
      }

      if (key) {
        return gugurStorage[key];
      }
    ...
    value: function set(key, value, options) {
      options = options || {};
      var gugurStorage = this.get(null, options);
      gugurStorage[key] = value;

      if (options.lifetimeInSeconds) {
        var date = new Date();
        date.setTime(date.getTime() + options.lifetimeInSeconds * 1000);
        gugurStorage.__expiration[key] = date.getTime();
      }
    ...
    value: function save(object, session) {
      ...
      storage.setItem('gugur', (0, _stringify.default)(object));
    }
  }]);
  return _default;
}(gugurModules.Module);
...
function (_gugurModules$Vie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          elements: '.gugur-element',
          nestedDocumentElements: '.gugur .gugur-element'
        },
        classes: {
          editMode: 'gugur-edit-mode'
        }
      };
    }
  }, {
    ...
    value: function getDocumentSettings(setting) {
      ...
      if (this.isEdit) {
        elementSettings = {};
        var settings = gugur.settings.page.model;
        jQuery.each(settings.getActiveControls(), function (controlKey) {
          elementSettings[controlKey] = settings.attributes[controlKey];
        });
      } else {
        elementSettings = this.$element.data('gugur-settings') || {};
      }
    ...
    value: function runElementsHandlers() {
      this.elements.$elements.each(function (index, element) {
        return gugurFrontend.elementsHandler.runReadyTrigger(element);
      });
    }
  }, {
    key: "onInit",
    value: function onInit() {
      ...
      if (this.isEdit) {
        gugur.settings.page.model.on('change', this.onSettingsChange.bind(this));
      } else {
...
var baseTabs =
/*#__PURE__*/
function (_gugurModules$fro) {
  (0, _inherits2.default)(baseTabs, _gugurModules$fro);
  ...
  (0, _createClass2.default)(baseTabs, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          tabTitle: '.gugur-tab-title',
          tabContent: '.gugur-tab-content'
        },
        classes: {
          active: 'gugur-active'
        },
...
/*#__PURE__*/
function (_gugurModules$Vie) {
  (0, _inherits2.default)(BaseLoader, _gugurModules$Vie);
...
/*#__PURE__*/
function (_gugurModules$fro) {
  (0, _inherits2.default)(BackgroundSlideshow, _gugurModules$fro);
  ...
  (0, _createClass2.default)(BackgroundSlideshow, [{
    ...
    value: function getDefaultSettings() {
      return {
        classes: {
          swiperContainer: 'gugur-background-slideshow swiper-container',
          swiperWrapper: 'swiper-wrapper',
          swiperSlide: 'gugur-background-slideshow__slide swiper-slide',
          swiperSlideInner: 'gugur-background-slideshow__slide__image',
          kenBurns: 'gugur-ken-burns',
          kenBurnsActive: 'gugur-ken-burns--active',
          kenBurnsIn: 'gugur-ken-burns--in',
          kenBurnsOut: 'gugur-ken-burns--out'
        }
      };
    }
  }, {
...
/*#__PURE__*/
function (_gugurModules$Vie) {
  (0, _inherits2.default)(Frontend, _gugurModules$Vie);
  ...
  function Frontend() {
    ...
    _this.config = gugurFrontendConfig;
    return _this;
  } // TODO: BC since 2.5.0
  ...
  (0, _createClass2.default)(Frontend, [{
    ...
    value: function getPageSettings(settingName) {
      var settingsObject = this.isEditMode() ? gugur.settings.page.model.attributes : this.config.settings.page;
      return this.getItems(settingsObject, settingName);
    }
  }, {
    key: "getGeneralSettings",
    value: function getGeneralSettings(settingName) {
      var settingsObject = this.isEditMode() ? gugur.settings.general.model.attributes : this.config.settings.general;
      return this.getItems(settingsObject, settingName);
    }
  }, {
    ...
    value: function getCurrentDeviceSetting(settings, settingKey) {
      return this.getDeviceSetting(gugurFrontend.getCurrentDeviceMode(), settings, settingKey);
    }
  }, {
    key: "isEditMode",
    ...
    value: function initOnReadyComponents() {
      ...
      this.modules = {
        StretchElement: gugurModules.frontend.tools.StretchElement,
        Masonry: gugurModules.utils.Masonry
      };
    ...
    value: function addIeCompatibility() {
      ...
      var msieCss = '<link rel="stylesheet" id="gugur-frontend-css-msie" href="' + this.config.urls.assets + 'css/frontend-msie.min.css?' + this.config.version + '" type="text/css" />';
      this.elements.$body.append(msieCss);
    }
  }, {
    key: "setDeviceModeData",
    value: function setDeviceModeData() {
      this.elements.$body.attr('data-gugur-device-mode', this.getCurrentDeviceMode());
    }
  }, {
    key: "addListenerOnce",
    ...
    value: function waypoint($element, callback, options) {
      ...
      return $element.gugurWaypoint(correctCallback, options);
    }
  }, {
    ...
    value: function init() {
      ...
      this.elements.$window.trigger('gugur/frontend/init');
    ...
    get: function get() {
      if (this.isEditMode()) {
        parent.gugurCommon.helpers.deprecatedMethod('gugurFrontend.Module', '2.5.0', 'gugurModules.frontend.handlers.Base');
      }

      return gugurModules.frontend.handlers.Base;
    }
  }]);
  return Frontend;
}(gugurModules.ViewModule);

window.gugurFrontend = new Frontend();

if (!gugurFrontend.isEditMode()) {
  jQuery(function () {
    return gugurFrontend.init();
  });
}
...
function (_gugurModules$Vie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function initDocumentClasses() {
      ...
      gugurFrontend.hooks.doAction('gugur/frontend/documents-manager/init-classes', this);
    }
  }, {
    ...
    value: function attachDocumentClass($document) {
      var documentData = $document.data(),
          documentID = documentData.gugurId,
          documentType = documentData.gugurType,
...
module.exports = function ($) {
  ...
  var addGlobalHandlers = function addGlobalHandlers() {
    gugurFrontend.hooks.addAction('frontend/element_ready/global', _global.default);
  };

  var addElementsHandlers = function addElementsHandlers() {
    $.each(handlers, function (elementName, funcCallback) {
      gugurFrontend.hooks.addAction('frontend/element_ready/' + elementName, funcCallback);
    });
  };
  ...
  this.runReadyTrigger = function (scope) {
    ...
    gugurFrontend.hooks.doAction('frontend/element_ready/global', $scope, $);
    gugurFrontend.hooks.doAction('frontend/element_ready/' + elementType, $scope, $);

    if ('widget' === elementType) {
      gugurFrontend.hooks.doAction('frontend/element_ready/' + $scope.attr('data-widget_type'), $scope, $);
    }
  };
...
var _default = function _default($scope) {
  gugurFrontend.elementsHandler.addHandler(_baseTabs.default, {
    $element: $scope,
    showTabFn: 'slideDown',
    hideTabFn: 'slideUp'
  });
...
/*#__PURE__*/
function (_gugurModules$fro) {
  (0, _inherits2.default)(Alert, _gugurModules$fro);
  ...
  (0, _createClass2.default)(Alert, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          dismissButton: '.gugur-alert-dismiss'
        }
      };
    }
  }, {
...
var _default = function _default($scope) {
  gugurFrontend.elementsHandler.addHandler(Alert, {
    $element: $scope
  });
};
...
/*#__PURE__*/
function (_gugurModules$fro) {
  (0, _inherits2.default)(Counter, _gugurModules$fro);
  ...
  (0, _createClass2.default)(Counter, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          counterNumber: '.gugur-counter-number'
        }
      };
    }
  }, {
    ...
    value: function onInit() {
      ...
      gugurFrontend.waypoint(this.elements.$counterNumber, function () {
...
var _default = function _default($scope) {
  gugurFrontend.elementsHandler.addHandler(Counter, {
    $element: $scope
  });
};
...
/*#__PURE__*/
function (_gugurModules$fro) {
  (0, _inherits2.default)(Progress, _gugurModules$fro);
  ...
  (0, _createClass2.default)(Progress, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          progressNumber: '.gugur-progress-bar'
        }
      };
    }
  }, {
    ...
    value: function onInit() {
      ...
      gugurFrontend.waypoint(this.elements.$progressNumber, function () {
...
var _default = function _default($scope) {
  gugurFrontend.elementsHandler.addHandler(Progress, {
    $element: $scope
  });
};
...
/*#__PURE__*/
function (_gugurModules$fro) {
  (0, _inherits2.default)(VideoModule, _gugurModules$fro);
  ...
  (0, _createClass2.default)(VideoModule, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          imageOverlay: '.gugur-custom-embed-image-overlay',
          video: '.gugur-video',
          videoIframe: '.gugur-video-iframe'
        }
      };
    }
  }, {
    ...
    value: function getLightBox() {
      return gugurFrontend.utils.lightbox;
    }
  }, {
    key: "handleVideo",
...
var _default = function _default($scope) {
  gugurFrontend.elementsHandler.addHandler(VideoModule, {
    $element: $scope
  });
};
...
/*#__PURE__*/
function (_gugurModules$fro) {
  (0, _inherits2.default)(ImageCarouselHandler, _gugurModules$fro);
  ...
  (0, _createClass2.default)(ImageCarouselHandler, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          carousel: '.gugur-image-carousel-wrapper',
    ...
    value: function getSwiperSettings() {
      var elementSettings = this.getElementSettings(),
          ...
          gugurBreakpoints = gugurFrontend.config.breakpoints;
      var swiperOptions = {
      ...
      swiperOptions.breakpoints[gugurBreakpoints.md] = {
        slidesPerView: +elementSettings.slides_to_show_mobile || 1,
        slidesPerGroup: +elementSettings.slides_to_scroll_mobile || 1
      };
      swiperOptions.breakpoints[gugurBreakpoints.lg] = {
...
var _default = function _default($scope) {
  gugurFrontend.elementsHandler.addHandler(ImageCarouselHandler, {
    $element: $scope
  });
};
...
/*#__PURE__*/
function (_gugurModules$fro) {
  (0, _inherits2.default)(TextEditor, _gugurModules$fro);
  ...
  (0, _createClass2.default)(TextEditor, [{
    ...
    value: function getDefaultSettings() {
      return {
        ...
        classes: {
          dropCap: 'gugur-drop-cap',
          dropCapLetter: 'gugur-drop-cap-letter'
        }
      };
    }
  }, {
...
var _default = function _default($scope) {
  gugurFrontend.elementsHandler.addHandler(TextEditor, {
    $element: $scope
  });
};
...
var _default = function _default($scope) {
  if (gugurFrontend.isEditMode() || $scope.hasClass('gugur-section-stretched')) {
    gugurFrontend.elementsHandler.addHandler(_stretchedSection.default, {
      $element: $scope
    });
  }

  if (gugurFrontend.isEditMode()) {
    gugurFrontend.elementsHandler.addHandler(_shapes.default, {
      $element: $scope
    });
    gugurFrontend.elementsHandler.addHandler(_handlesPosition.default, {
      $element: $scope
    });
  }

  gugurFrontend.elementsHandler.addHandler(_backgroundVideo.default, {
    $element: $scope
  });
  gugurFrontend.elementsHandler.addHandler(_backgroundSlideshow.default, {
    $element: $scope
  });
};
...
/*#__PURE__*/
function (_gugurModules$fro) {
  (0, _inherits2.default)(BackgroundVideo, _gugurModules$fro);
  ...
  (0, _createClass2.default)(BackgroundVideo, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          backgroundVideoContainer: '.gugur-background-video-container',
          backgroundVideoEmbed: '.gugur-background-video-embed',
          backgroundVideoHosted: '.gugur-background-video-hosted'
        }
      };
    }
  }, {
    ...
    value: function prepareVimeoVideo(Vimeo, videoId) {
      ...
      this.player.ready().then(function () {
        jQuery(_this2.player.element).addClass('gugur-background-video-embed');
    ...
    value: function prepareYTVideo(YT, videoID) {
      ...
      $backgroundVideoContainer.addClass('gugur-loading gugur-invisible');
      this.player = new YT.Player(this.elements.$backgroundVideoEmbed[0], {
        ...
        events: {
          ...
          onStateChange: function onStateChange(event) {
            switch (event.data) {
              case startStateCode:
                $backgroundVideoContainer.removeClass('gugur-invisible gugur-loading');
                break;
    ...
    value: function activate() {
      ...
      if (-1 !== videoLink.indexOf('vimeo.com')) {
        ...
        this.apiProvider = gugurFrontend.utils.vimeo;
      } else if (videoLink.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/)) {
        this.videoType = 'youtube';
        this.apiProvider = gugurFrontend.utils.youtube;
      }
      ...
      gugurFrontend.elements.$window.on('resize', this.changeVideoSize);
    }
  }, {
    key: "deactivate",
    value: function deactivate() {
      ...
      gugurFrontend.elements.$window.off('resize', this.changeVideoSize);
    }
  }, {
    key: "run",
    value: function run() {
      ...
      if (!elementSettings.background_play_on_mobile && 'mobile' === gugurFrontend.getCurrentDeviceMode()) {
        return;
      }
...
/*#__PURE__*/
function (_gugurModules$fro) {
  (0, _inherits2.default)(HandlesPosition, _gugurModules$fro);
  ...
  (0, _createClass2.default)(HandlesPosition, [{
    ...
    value: function isFirstSection() {
      return this.$element.is('.gugur-edit-mode .gugur-top-section:first');
    }
  }, {
    ...
    value: function getOffset() {
      if ('body' === gugur.config.document.container) {
        return this.$element.offset().top;
      }

      var $container = jQuery(gugur.config.document.container);
    ...
    value: function setHandlesPosition() {
      ...
      var offset = isOverflowHidden ? 0 : this.getOffset(),
          $handlesElement = this.$element.find('> .gugur-element-overlay > .gugur-editor-section-settings'),
          insideHandleClass = 'gugur-section--handles-inside';
...
/*#__PURE__*/
function (_gugurModules$fro) {
  (0, _inherits2.default)(StretchedSection, _gugurModules$fro);
  ...
  (0, _createClass2.default)(StretchedSection, [{
    ...
    value: function bindEvents() {
      ...
      gugurFrontend.addListenerOnce(handlerID, 'resize', this.stretch);
      gugurFrontend.addListenerOnce(handlerID, 'sticky:stick', this.stretch, this.$element);
      gugurFrontend.addListenerOnce(handlerID, 'sticky:unstick', this.stretch, this.$element);
    }
  }, {
    key: "unbindEvents",
    value: function unbindEvents() {
      gugurFrontend.removeListeners(this.getUniqueHandlerID(), 'resize', this.stretch);
    }
  }, {
    key: "initStretch",
    value: function initStretch() {
      this.stretch = this.stretch.bind(this);
      this.stretchElement = new gugurModules.frontend.tools.StretchElement({
    ...
    value: function getStretchContainer() {
      return gugurFrontend.getGeneralSettings('gugur_stretched_section_container') || window;
    }
  }, {
    key: "stretch",
    ...
    value: function onGeneralSettingsChange(changed) {
      if ('gugur_stretched_section_container' in changed) {
...
/*#__PURE__*/
function (_gugurModules$fro) {
  (0, _inherits2.default)(Shapes, _gugurModules$fro);
  ...
  (0, _createClass2.default)(Shapes, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          container: '> .gugur-shape-%s'
        },
        svgURL: gugurFrontend.config.urls.assets + 'shapes/'
      };
    }
  }, {
    key: "getDefaultElements",
    ...
    value: function getSvgURL(shapeType, fileName) {
      ...
      if (gugur.config.additional_shapes && shapeType in gugur.config.additional_shapes) {
        svgURL = gugur.config.additional_shapes[shapeType];
      }
...
/*#__PURE__*/
function (_gugurModules$fro) {
  (0, _inherits2.default)(GlobalHandler, _gugurModules$fro);
  ...
  (0, _createClass2.default)(GlobalHandler, [{
    ...
    value: function animate() {
      ...
      if ('none' === animation) {
        $element.removeClass('gugur-invisible');
        return;
      }
      ...
      setTimeout(function () {
        $element.removeClass('gugur-invisible').addClass('animated ' + animation);
      }, animationDelay);
    }
  }, {
    key: "getAnimation",
    ...
    value: function onInit() {
      ...
      if (this.getAnimation()) {
        gugurFrontend.waypoint(this.$element, function () {
...
var _default = function _default($scope) {
  gugurFrontend.elementsHandler.addHandler(GlobalHandler, {
    $element: $scope
  });
};
...
module.exports = gugurModules.ViewModule.extend({
  getDefaultSettings: function getDefaultSettings() {
    return {
      ...
      selectors: {
        links: 'a[href*="#"]',
        targets: '.gugur-element, .gugur-menu-anchor',
  ...
  bindEvents: function bindEvents() {
    gugurFrontend.elements.$document.on('click', this.getSettings('selectors.links'), this.handleAnchorLinks);
  },
  handleAnchorLinks: function handleAnchorLinks(event) {
    ...
    var scrollTop = $anchor.offset().top,
        ...
        $activeStickies = jQuery('.gugur-section.gugur-sticky--active'),
        maxStickyHeight = 0;
    ...
    event.preventDefault();
    scrollTop = gugurFrontend.hooks.applyFilters('frontend/handlers/menu_anchor/scroll_top_distance', scrollTop);
...
module.exports = gugurModules.ViewModule.extend({
  ...
  getDefaultSettings: function getDefaultSettings() {
    return {
      classes: {
        aspectRatio: 'gugur-aspect-ratio-%s',
        item: 'gugur-lightbox-item',
        image: 'gugur-lightbox-image',
        videoContainer: 'gugur-video-container',
        videoWrapper: 'gugur-fit-aspect-ratio',
        playButton: 'gugur-custom-embed-play',
        playButtonIcon: 'fa',
        playing: 'gugur-playing',
        hidden: 'gugur-hidden',
        invisible: 'gugur-invisible',
        preventClose: 'gugur-lightbox-prevent-close',
        slideshow: {
          container: 'swiper-container',
          slidesWrapper: 'swiper-wrapper',
          prevButton: 'gugur-swiper-button gugur-swiper-button-prev',
          nextButton: 'gugur-swiper-button gugur-swiper-button-next',
  ...
  initModal: function initModal() {
    var modal = module.exports.modal = gugurFrontend.getDialogsManager().createWidget('lightbox', {
      className: 'gugur-lightbox',
      closeButton: true,
  ...
  setVideoContent: function setVideoContent(options) {
    ...
    modal.onHide = function () {
      onHideMethod();
      modal.getElements('message').removeClass('gugur-fit-aspect-ratio');
    };
  },
  setSlideshowContent: function setSlideshowContent(options) {
    ...
    options.slides.forEach(function (slide) {
      ...
      if (slide.video) {
        $slide.attr('data-gugur-slideshow-video', slide.video);
        var $playIcon = $('<div>', {
  ...
  playSlideVideo: function playSlideVideo() {
    ...
    var $activeSlide = this.getSlide('active'),
        videoURL = $activeSlide.data('gugur-slideshow-video');
    ...
    if (-1 !== videoURL.indexOf('vimeo.com')) {
      videoType = 'vimeo';
      apiProvider = gugurFrontend.utils.vimeo;
    } else if (videoURL.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/)) {
      videoType = 'youtube';
      apiProvider = gugurFrontend.utils.youtube;
    }
  ...
  prepareYTVideo: function prepareYTVideo(YT, videoID, $videoContainer, $videoWrapper, $playIcon) {
    ...
    $videoContainer.addClass('gugur-loading' + ' ' + classes.invisible);
      ...
      events: {
        ...
        onStateChange: function onStateChange(event) {
          if (event.data === startStateCode) {
            $videoContainer.removeClass('gugur-loading' + ' ' + classes.invisible);
          }
        }
      },
      playerVars: {
  ...
  setEntranceAnimation: function setEntranceAnimation(animation) {
    animation = animation || gugurFrontend.getCurrentDeviceSetting(this.getSettings('modalOptions'), 'entranceAnimation');
  ...
  isLightboxLink: function isLightboxLink(element) {
    ...
    var generalOpenInLightbox = gugurFrontend.getGeneralSettings('gugur_global_image_lightbox'),
        currentLinkOpenInLightbox = element.dataset.gugurOpenLightbox;
    return 'yes' === currentLinkOpenInLightbox || generalOpenInLightbox && 'no' !== currentLinkOpenInLightbox;
  },
  openLink: function openLink(event) {
    var element = event.currentTarget,
        $target = jQuery(event.target),
        editMode = gugurFrontend.isEditMode(),
        isClickInsidegugur = !!$target.closest('#gugur').length;

    if (!this.isLightboxLink(element)) {
      if (editMode && isClickInsidegugur) {
        event.preventDefault();
      }
    ...
    if (editMode && !gugurFrontend.getGeneralSettings('gugur_enable_lightbox_in_editor')) {
      return;
    }

    var lightboxData = {};

    if (element.dataset.gugurLightbox) {
      lightboxData = JSON.parse(element.dataset.gugurLightbox);
    }
    ...
    if (!element.dataset.gugurLightboxSlideshow) {
      this.showModal({
        type: 'image',
        url: element.href
      });
    ...
    var slideshowID = element.dataset.gugurLightboxSlideshow;
    var $allSlideshowLinks = jQuery(this.getSettings('selectors.links')).filter(function () {
      var $this = jQuery(this);
      return slideshowID === this.dataset.gugurLightboxSlideshow && !$this.parent('.swiper-slide-duplicate').length && !$this.parents('.slick-cloned').length;
    });
    var slides = [];
    $allSlideshowLinks.each(function () {
      var slideVideo = this.dataset.gugurLightboxVideo;
      var slideIndex = this.dataset.gugurLightboxIndex;
    ...
    var initialSlide = element.dataset.gugurLightboxIndex;
    ...
    this.showModal({
      type: 'slideshow',
      modalOptions: {
        id: 'gugur-lightbox-slideshow-' + slideshowID
      },
      slideshow: {
        slides: slides,
        swiper: {
  ...
  bindEvents: function bindEvents() {
    gugurFrontend.elements.$document.on('click', this.getSettings('selectors.links'), this.openLink);
  },
