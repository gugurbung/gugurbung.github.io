<?php
namespace gugur\Core\Common\Modules\Connect;

use gugur\Core\Base\Module as BaseModule;
use gugur\Core\Common\Modules\Connect\Apps\Base_App;
use gugur\Core\Common\Modules\Connect\Apps\Connect;
...
class Module extends BaseModule {
	...
	public function __construct() {
		...
		// Note: The priority 11 is for allowing plugins to add their register callback on gugur init.
		add_action( 'gugur/init', [ $this, 'init' ], 11 );
	}
	...
	public function init() {
		 ...
		 * Register gugur apps.
		 *
		 * Fires after gugur registers the default apps.
		 *
		 * @since 2.3.0
		 *
		 * @param self $this The apps manager instance.
		 */
		do_action( 'gugur/connect/apps/register', $this );
