...
/**
 * gugur settings manager.
 *
 * gugur settings manager handler class is responsible for registering and
 * managing gugur settings managers.
 *
 * @since 1.6.0
 */
class Manager {
	 ...
	 *
	 * Holds the names for builtin gugur settings managers.
	 *
	 * @since 1.6.0
	 * @access private
	 *
	 ...
	 *
	 * Register builtin gugur settings managers.
	 *
	 * @since 1.6.0
	 * @access private
	 * @static
