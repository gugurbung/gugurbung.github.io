<?php
namespace gugur\Core\Settings\Page;
...
/**
 * gugur page settings model.
 *
 * gugur page settings model handler class is responsible for registering
 * and managing gugur page settings models.
 *
 * @since 1.6.0
 */
class Model extends BaseModel {
	 ...
	 * Model constructor.
	 *
	 * Initializing gugur page settings model.
	 *
	 * @since 1.6.0
	 * @access public
	 *
	...
	public function get_panel_page_settings() {
		...
		return [
			...
			'title' => sprintf( __( '%s Settings', 'gugur' ), $document::get_title() ),
		];
	}
	 ...
	 * exclude it from the exported gugur data.
	 *
	 * @since 1.6.0
	 * @access public
	 *
	...
	public function on_export( $element_data ) {
		if ( ! empty( $element_data['settings']['template'] ) ) {
			...
			$is_gugur_template = ! ! $page_templates_module->get_template_path( $element_data['settings']['template'] );

			if ( ! $is_gugur_template ) {
