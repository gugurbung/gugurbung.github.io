...
class Admin extends App {
	...
	public function admin_notices() {
		...
		?>
		<div class="notice is-dismissible updated gugur-message-dismissed gugur-message-announcement" data-notice_id="<?php echo esc_attr( $notice_id ); ?>">
	 ...
	 *
	 * Add gugur upgrades notices to WordPress admin screen.
	 *
