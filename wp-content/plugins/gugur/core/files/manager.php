<?php
namespace gugur\Core\Files;

use gugur\Core\Files\CSS\Global_CSS;
use gugur\Core\Files\CSS\Post as Post_CSS;
use gugur\Core\Files\Svg\Svg_Handler;
use gugur\Core\Responsive\Files\Frontend;
use gugur\Utils;
...
class Manager {
	 ...
	 *
	 * Initializing the gugur files manager.
	 *
	 * @since 1.2.0
	 * @access public
	 */
	 ...
	 * export won't contain the post CSS file data used by gugur.
	 *
	...
	public function clear_cache() {
		 ...
		 * gugur clear files.
		 *
		 * Fires after gugur clears files
		 *
		 * @since 2.1.0
		 */
		do_action( 'gugur/core/files/clear_cache' );
	}
