...
use gugur\Core\Debug\Classes\Inspection_Base;
use gugur\Core\Debug\Classes\Theme_Missing;
use gugur\Core\Debug\Classes\Htaccess;
...
class Loading_Inspection_Manager {
	...
	public function run_inspections() {
		$debug_data = [
			'message' => __( 'We\'re sorry, but something went wrong. Click on \'Learn more\' and follow each of the steps to quickly solve it.', 'gugur' ),
			'header' => __( 'The preview could not be loaded', 'gugur' ),
			'doc_url' => 'https://go.gugur.com/preview-not-loaded/',
		];
