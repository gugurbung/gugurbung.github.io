...
include_once gugur_PATH . '/includes/libraries/wp-background-process/wp-async-request.php';
include_once gugur_PATH . '/includes/libraries/wp-background-process/wp-background-process.php';
...
abstract class Background_Task extends \WP_Background_Process {
	...
	public function schedule_cron_healthcheck( $schedules ) {
		...
		$schedules[ $this->identifier . '_cron_interval' ] = array(
			...
			'display' => sprintf( __( 'Every %d minutes', 'gugur' ), $interval ),
		);
	...
	/**
	 * @var \gugur\Core\Base\Background_Task_Manager
	 */
	protected $manager;
	...
	public function __construct( $manager ) {
		...
		$this->prefix = 'gugur_' . get_current_blog_id();
