<?php
namespace gugur\System_Info;

use gugur\System_Info\Classes\Abstracts\Base_Reporter;
use gugur\System_Info\Helpers\Model_Helper;
...
/**
 * gugur main system info page.
 *
 * gugur main system info page handler class responsible for creating system info
 * reports and displaying them on WordPress dashboard under gugur setting.
 *
 * @since 1.0.0
 */
class Main {
	 ...
	 *
	 * Holds the user capabilities required to manage gugur menus.
	 *
	 * @since 1.0.0
	 * @access private
	 *
	 ...
	 *
	 * Holds the settings required for gugur system info page.
	 *
	 * @since 1.0.0
	 * @access private
	 *
	...
	/**
	 * gugur system info reports.
	 *
	 * Holds an array of available reports in gugur system info page.
	 *
	 * @since 1.0.0
	 * @access private
	 *
	 ...
	 *
	 * Initializing gugur system info page.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	 ...
	 * Require files.
	 *
	 * Require the needed files for gugur system info page.
	 *
	 * @since 1.0.0
	 * @access private
	 */
	 ...
	 * Create a report.
	 *
	 * Register a new report that will be displayed in gugur system info page.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	private function add_actions() {
		...
		add_action( 'wp_ajax_gugur_system_info_download_file', [ $this, 'download_file' ] );
	}
	...
	public function display_page() {
		...
		?>
		<div id="gugur-system-info">
			<h3><?php echo __( 'System Info', 'gugur' ); ?></h3>
			<div><?php $this->print_report( $reports, 'html' ); ?></div>
			<h3><?php echo __( 'Copy & Paste Info', 'gugur' ); ?></h3>
			<div id="gugur-system-info-raw">
				<label id="gugur-system-info-raw-code-label" for="gugur-system-info-raw-code"><?php echo __( 'You can copy the below info as simple text with Ctrl+C / Ctrl+V:', 'gugur' ); ?></label>
				<textarea id="gugur-system-info-raw-code" readonly>
					<?php
				...
				<script>
					var textarea = document.getElementById( 'gugur-system-info-raw-code' );
			...
			<form action="<?php echo admin_url( 'admin-ajax.php' ); ?>" method="post">
				<input type="hidden" name="action" value="gugur_system_info_download_file">
				<input type="submit" class="button button-primary" value="<?php echo __( 'Download System Info', 'gugur' ); ?>">
			</form>
		</div>
		<?php
	}
	 ...
	 *
	 * Fired by `wp_ajax_gugur_system_info_download_file` action.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	public function download_file() {
		if ( ! current_user_can( $this->capability ) ) {
			wp_die( __( 'You don\'t have permissions to download this file', 'gugur' ) );
		}
	 ...
	 * Register admin menu.
	 *
	 * Add new gugur system info admin menu.
	 *
	...
	public function register_menu() {
		$system_info_text = __( 'System Info', 'gugur' );
	...
	protected function get_default_settings() {
		...
		$base_lib_dir = gugur_PATH . 'includes/settings/system-info/';
	 ...
	 * Init settings.
	 *
	 * Initialize gugur system info page by setting default settings.
	 *
	 * @since 1.0.0
	 * @access private
	 */
	 ...
	 * @access public
	 *
	 * @param array $setting   Optional. Settings required for gugur system
	 ...
	 * Get allowed reports.
	 *
	 * Retrieve the available reports in gugur system info page.
	 *
	 * @since 1.0.0
	 * @access public
	 * @static
	 *
	 * @return array Available reports in gugur system info page.
	 */
	 ...
	 * Add report.
	 *
	 * Register a new report to gugur system info page.
	 *
	 * @since 1.4.0
	 * @access public
	 * @static
