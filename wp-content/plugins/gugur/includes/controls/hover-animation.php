...
class Control_Hover_Animation extends Base_Data_Control {
	...
	public static function get_animations() {
		if ( is_null( self::$_animations ) ) {
			 ...
			 */
			$additional_animations = apply_filters( 'gugur/controls/hover_animations/additional_animations', $additional_animations );
		...
		<div class="gugur-control-field">
			...
			<div class="gugur-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" data-setting="{{ data.name }}">
					<option value=""><?php echo __( 'None', 'gugur' ); ?></option>
