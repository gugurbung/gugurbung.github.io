...
class Control_Section extends Base_UI_Control {
	...
	public function content_template() {
		...
		<div class="gugur-panel-heading">
			<div class="gugur-panel-heading-toggle gugur-section-toggle" data-collapse_id="{{ data.name }}">
				<i class="eicon" aria-hidden="true"></i>
			</div>
			<div class="gugur-panel-heading-title gugur-section-title">{{{ data.label }}}</div>
		</div>
		<?php
	}
