	...
	public function content_template() {
		...
		<div class="gugur-control-field">
			...
			<div class="gugur-control-input-wrapper">
				<textarea id="<?php echo $control_uid; ?>" class="gugur-control-tag-area" rows="{{ data.rows }}" data-setting="{{ data.name }}" placeholder="{{ data.placeholder }}"></textarea>
			</div>
		</div>
		<# if ( data.description ) { #>
