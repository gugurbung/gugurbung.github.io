	...
	public function content_template() {
		...
		<div class="gugur-control-field">
			...
			<div class="gugur-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" class="gugur-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php echo __( 'Select Icon', 'gugur' ); ?>">
					<option value=""><?php echo __( 'Select Icon', 'gugur' ); ?></option>
