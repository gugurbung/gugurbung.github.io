...
class Control_Animation extends Base_Data_Control {
	...
	public static function get_animations() {
		 ...
		 */
		$additional_animations = apply_filters( 'gugur/controls/animations/additional_animations', [] );
		...
		<div class="gugur-control-field">
			...
			<div class="gugur-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" data-setting="{{ data.name }}">
					...
					<option value="none"><?php echo __( 'None', 'gugur' ); ?></option>
