...
class Control_Repeater extends Base_Data_Control {
	 ...
	 * Import repeater.
	 *
	 * Used as a wrapper method for inner controls while importing gugur
	...
	public function content_template() {
		...
		<div class="gugur-repeater-fields-wrapper"></div>
		<# if ( itemActions.add ) { #>
			<div class="gugur-button-wrapper">
				<button class="gugur-button gugur-button-default gugur-repeater-add" type="button">
					<i class="eicon-plus" aria-hidden="true"></i><?php echo __( 'Add Item', 'gugur' ); ?>
				</button>
			</div>
		<# } #>
		<?php
