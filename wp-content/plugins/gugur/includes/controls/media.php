			...
			<div class="gugur-control-input-wrapper gugur-aspect-ratio-219">
				<div class="gugur-control-media__content gugur-control-tag-area gugur-control-preview-area gugur-fit-aspect-ratio">
					...
					<div class="gugur-control-media-area gugur-fit-aspect-ratio">
						...
						<video class="gugur-control-media-video" preload="metadata"></video>
						<i class="eicon-video-camera"></i>
						<# } #>
					</div>
					<div class="gugur-control-media__tools">
						<# if( 'image' === data.media_type ) { #>
						<div class="gugur-control-media__tool gugur-control-media__replace"><?php echo __( 'Choose Image', 'gugur' ); ?></div>
						<# } else if( 'video' === data.media_type ) { #>
						<div class="gugur-control-media__tool gugur-control-media__replace"><?php echo __( 'Choose Video', 'gugur' ); ?></div>
						<# } #>
					</div>
				</div>
			</div>
