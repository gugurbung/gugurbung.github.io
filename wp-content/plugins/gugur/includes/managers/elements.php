...
/**
 * gugur elements manager.
 *
 * gugur elements manager handler class is responsible for registering and
...
class Elements_Manager {
	 ...
	 *
	 * Initializing gugur elements manager.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	 ...
	 * Init elements.
	 *
	 * Initialize gugur elements by registering the supported elements.
	 * gugur supports by default `section` element and `column` element.
	 *
	 * @since 2.0.0
	 * @access private
	 */
	private function init_elements() {
		 ...
		 *
		 * Fires after gugur elements are registered.
		 *
		 * @since 1.0.0
		 */
		do_action( 'gugur/elements/elements_registered' );
	}
	...
	private function init_categories() {
		 ...
		 */
		do_action( 'gugur/elements/categories_registered', $this );

		$this->categories['pojo'] = [
			'title' => __( 'Pojo Themes', 'gugur' ),
			'icon' => 'eicon-pojome',
		];

		$this->categories['wordpress'] = [
			'title' => __( 'WordPress', 'gugur' ),
	 ...
	 * Require files.
	 *
	 * Require gugur element base class and column, section and repeater
	 * elements.
	 *
	 * @since 1.0.0
	 * @access private
	...
	private function require_files() {
		require_once gugur_PATH . 'includes/base/element-base.php';

		require gugur_PATH . 'includes/elements/column.php';
		require gugur_PATH . 'includes/elements/section.php';
		require gugur_PATH . 'includes/elements/repeater.php';
	}
}
