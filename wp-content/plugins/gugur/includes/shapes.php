 ...
 * gugur shapes.
 *
 * gugur shapes handler class is responsible for setting up the supported
 * shape dividers.
 *
 * @since 1.3.0
 */
class Shapes {
	...
	public static function get_shape_path( $shape, $is_negative = false ) {
		...
		return gugur_PATH . 'assets/shapes/' . $file_name . '.svg';
	}
	...
	private static function init_shapes() {
		$native_shapes = [
			'mountains' => [
				'title' => _x( 'Mountains', 'Shapes', 'gugur' ),
				'has_flip' => true,
			],
			'drops' => [
				'title' => _x( 'Drops', 'Shapes', 'gugur' ),
				'has_negative' => true,
				'has_flip' => true,
				'height_only' => true,
			],
			'clouds' => [
				'title' => _x( 'Clouds', 'Shapes', 'gugur' ),
				'has_negative' => true,
				'has_flip' => true,
				'height_only' => true,
			],
			'zigzag' => [
				'title' => _x( 'Zigzag', 'Shapes', 'gugur' ),
			],
			'pyramids' => [
				'title' => _x( 'Pyramids', 'Shapes', 'gugur' ),
				'has_negative' => true,
				'has_flip' => true,
			],
			'triangle' => [
				'title' => _x( 'Triangle', 'Shapes', 'gugur' ),
				'has_negative' => true,
			],
			'triangle-asymmetrical' => [
				'title' => _x( 'Triangle Asymmetrical', 'Shapes', 'gugur' ),
				'has_negative' => true,
				'has_flip' => true,
			],
			'tilt' => [
				'title' => _x( 'Tilt', 'Shapes', 'gugur' ),
				'has_flip' => true,
				'height_only' => true,
			],
			'opacity-tilt' => [
				'title' => _x( 'Tilt Opacity', 'Shapes', 'gugur' ),
				'has_flip' => true,
			],
			'opacity-fan' => [
				'title' => _x( 'Fan Opacity', 'Shapes', 'gugur' ),
			],
			'curve' => [
				'title' => _x( 'Curve', 'Shapes', 'gugur' ),
				'has_negative' => true,
			],
			'curve-asymmetrical' => [
				'title' => _x( 'Curve Asymmetrical', 'Shapes', 'gugur' ),
				'has_negative' => true,
				'has_flip' => true,
			],
			'waves' => [
				'title' => _x( 'Waves', 'Shapes', 'gugur' ),
				'has_negative' => true,
				'has_flip' => true,
			],
			'wave-brush' => [
				'title' => _x( 'Waves Brush', 'Shapes', 'gugur' ),
				'has_flip' => true,
			],
			'waves-pattern' => [
				'title' => _x( 'Waves Pattern', 'Shapes', 'gugur' ),
				'has_flip' => true,
			],
			'arrow' => [
				'title' => _x( 'Arrow', 'Shapes', 'gugur' ),
				'has_negative' => true,
			],
			'split' => [
				'title' => _x( 'Split', 'Shapes', 'gugur' ),
				'has_negative' => true,
			],
			'book' => [
				'title' => _x( 'Book', 'Shapes', 'gugur' ),
				'has_negative' => true,
			],
		];
	 ...
	 *
	 * Used to add custom shapes to gugur.
	 *
	 * @since 2.5.0
	 *
	 * @return array
	...
	private static function get_additional_shapes() {
		 ...
		 * Additional shapes.
		 *
		 * Filters the shapes used by gugur to add additional shapes.
		 *
		 * @since 2.0.1
		 *
		 * @param array $additional_shapes Additional gugur shapes.
		 */
		$additional_shapes = apply_filters( 'gugur/shapes/additional_shapes', $additional_shapes );
		return $additional_shapes;
	}
