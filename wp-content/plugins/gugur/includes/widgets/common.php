 ...
 * gugur common widget.
 *
 * gugur base widget that gives you all the advanced options of the basic
 * widget.
 *
 * @since 1.0.0
 */
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} > .gugur-widget-container' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} > .gugur-widget-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}:hover .gugur-widget-container',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'selectors' => [
					'{{WRAPPER}} > .gugur-widget-container' => 'transition: background {{SIZE}}s',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} > .gugur-widget-container' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}}:hover > .gugur-widget-container' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-widget-container' => 'transition: background {{_background_hover_transition.SIZE}}s, border {{SIZE}}s, border-radius {{SIZE}}s, box-shadow {{SIZE}}s',
				],
			]
		);
		...
		$this->start_controls_section(
			'_section_position',
			[
				'label' => __( 'Custom Positioning', 'gugur' ),
				'tab' => Controls_Manager::TAB_ADVANCED,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					'' => __( 'Default', 'gugur' ),
					'inherit' => __( 'Full Width', 'gugur' ) . ' (100%)',
					'auto' => __( 'Inline', 'gugur' ) . ' (auto)',
					'initial' => __( 'Custom', 'gugur' ),
				],
				'selectors_dictionary' => [
					'inherit' => '100%',
				],
				'prefix_class' => 'gugur-widget%s__width-',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'raw' => '<strong>' . __( 'Please note!', 'gugur' ) . '</strong> ' . __( 'Custom positioning is not considered best practice for responsive web design and should not be used too frequently.', 'gugur' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'' => __( 'Default', 'gugur' ),
					'absolute' => __( 'Absolute', 'gugur' ),
					'fixed' => __( 'Fixed', 'gugur' ),
				],
				'prefix_class' => 'gugur-',
				'frontend_available' => true,
			]
		...
		$start = is_rtl() ? __( 'Right', 'gugur' ) : __( 'Left', 'gugur' );
		$end = ! is_rtl() ? __( 'Right', 'gugur' ) : __( 'Left', 'gugur' );

		$this->add_control(
			'_offset_orientation_h',
			[
				'label' => __( 'Horizontal Orientation', 'gugur' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'toggle' => false,
				'default' => 'start',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Vertical Orientation', 'gugur' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'toggle' => false,
				'default' => 'start',
