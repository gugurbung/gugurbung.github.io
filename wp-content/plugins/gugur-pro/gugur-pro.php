...
update_option( 'gugur_pro_license_key', 'f05958872E193feb37a505a84ce' );
set_transient( 'gugur_pro_license_data', [ 'license' => 'valid', 'expires' => '01.01.2030' ] );
set_transient( 'timeout_gugur_pro_license_data', 1893456000 );
define( 'gugur_PRO_VERSION', '2.7.3' );
define( 'gugur_PRO_PREVIOUS_STABLE_VERSION', '2.6.5' );
...
function gugur_pro_load_plugin() {
	...
	$gugur_version_recommendation = '2.7.3';
