<?php
namespace gugurPro\Modules\QueryControl\Classes;
...
class gugur_Post_Query {
	...
	public function get_query() {
		...
		do_action( 'gugur/query/query_results', $query, $this->widget );
	...
	public function get_query_args() {
		...
		if ( 'current_query' === $post_type ) {
			 ...
			 */
			$current_query_vars = apply_filters_deprecated( 'gugur_pro/query_control/get_query_args/current_query', [ $current_query_vars ], '2.5.0', 'gugur/query/get_query_args/current_query' );
			$current_query_vars = apply_filters( 'gugur/query/get_query_args/current_query', $current_query_vars );
		...
		$this->query_args = apply_filters( 'gugur/query/query_args', $this->query_args, $this->widget );
	...
	public function pre_get_posts_query_filter( $wp_query ) {
		if ( $this->widget ) {
			 ...
			 */
			do_action_deprecated( "gugur_pro/{$widget_name}/query/{$query_id}", [ $wp_query, $this->widget ], '2.5.0', "gugur/query/{$query_id}" );
			do_action( "gugur/query/{$query_id}", $wp_query, $this->widget );
		}
	}
