 ...
 * @deprecated since 2.5.0, use class Group_Control_Query and gugur_Post_Query
 */
class Group_Control_Posts extends Group_Control_Base {
	...
	protected function prepare_fields( $fields ) {
		...
		$post_types_options['by_id'] = __( 'Manual Selection', 'gugur-pro' );
		$post_types_options['current_query'] = __( 'Current Query', 'gugur-pro' );
