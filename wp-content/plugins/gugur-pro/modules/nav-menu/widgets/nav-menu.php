		...
		if ( ! empty( $menus ) ) {
			...
			$this->add_control(
				...
				[
					...
					'raw' => '<strong>' . __( 'There are no menus in your site.', 'gugur-pro' ) . '</strong><br>' . sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'gugur-pro' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
					'separator' => 'after',
