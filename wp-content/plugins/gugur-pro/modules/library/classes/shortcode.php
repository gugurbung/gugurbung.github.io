<?php
namespace gugurPro\Modules\Library\Classes;
...
class Shortcode {
	...
	const SHORTCODE = 'gugur-template';
	...
	public function admin_columns_headers( $defaults ) {
		$defaults['shortcode'] = __( 'Shortcode', 'gugur-pro' );
	...
	public function admin_columns_content( $column_name, $post_id ) {
		if ( 'shortcode' === $column_name ) {
			...
			printf( '<input class="gugur-shortcode-input" type="text" readonly onfocus="this.select()" value="%s" />', $shortcode );
		}
	}
	...
	public function shortcode( $attributes = [] ) {
		...
		return Plugin::gugur()->frontend->get_builder_content_for_display( $attributes['id'], $include_css );
	}
