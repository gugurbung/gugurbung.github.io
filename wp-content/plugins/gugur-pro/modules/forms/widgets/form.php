...
use gugurPro\Modules\Forms\Classes\Recaptcha_Handler;
use gugurPro\Modules\Forms\Classes\Recaptcha_V3_Handler;
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			'recaptcha_badge', [
				...
				'default' => 'bottomright',
				'options' => [
					'bottomright' => __( 'Bottom Right', 'gugur-pro' ),
					'bottomleft' => __( 'Bottom Left', 'gugur-pro' ),
					'inline' => __( 'Inline', 'gugur-pro' ),
				],
				'description' => __( 'To view the validation badge, switch to preview mode', 'gugur-pro' ),
				'conditions' => [
					'terms' => [
						[
							'name' => 'field_type',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .gugur-field-group.recaptcha_v3-bottomleft, {{WRAPPER}} .gugur-field-group.recaptcha_v3-bottomright' => 'margin-bottom: 0;',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gugur-field-type-html' => 'padding-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .gugur-field-type-html' => 'color: {{VALUE}};',
				],
				'scheme' => [
					'type' => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_3,
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .gugur-field-type-html',
				'scheme' => Scheme_Typography::TYPOGRAPHY_3,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .gugur-button svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		<form class="gugur-form" id="{{settings.form_id}}" name="{{settings.form_name}}">
			<div class="gugur-form-fields-wrapper gugur-labels-{{settings.label_position}}">
				<#
					...
					var iconHTML = gugur.helpers.renderIcon( view, settings.selected_button_icon, { 'aria-hidden': true }, 'i' , 'object' ),
						migrated = gugur.helpers.isIconMigrated( settings, 'selected_button_icon' );
