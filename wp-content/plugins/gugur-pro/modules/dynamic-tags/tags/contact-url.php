...
class Contact_URL extends Tag {
	...
	public function get_title() {
		return __( 'Contact URL', 'gugur-pro' );
	}
	...
	protected function _register_controls() {
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'sms' => __( 'SMS', 'gugur-pro' ),
					'whatsapp' => __( 'WhatsApp', 'gugur-pro' ),
					'skype' => __( 'Skype', 'gugur-pro' ),
					'messenger' => __( 'Messenger', 'gugur-pro' ),
					'viber' => __( 'Viber', 'gugur-pro' ),
					'waze' => __( 'Waze', 'gugur-pro' ),
					'google_calendar' => __( 'Google Calendar', 'gugur-pro' ),
					'outlook_calendar' => __( 'Outlook Calendar', 'gugur-pro' ),
					'yahoo_calendar' => __( 'Yahoo Calendar', 'gugur-pro' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'contact' => __( 'Contact', 'gugur-pro' ),
					'add' => __( 'Add', 'gugur-pro' ),
				],
				'default' => 'contact',
				'condition' => [
					'link_type' => 'viber',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'call' => __( 'Call', 'gugur-pro' ),
					'chat' => __( 'Chat', 'gugur-pro' ),
					'userinfo' => __( 'Show Profile', 'gugur-pro' ),
					'add' => __( 'Add to Contacts', 'gugur-pro' ),
					'voicemail' => __( 'Send Voice Mail', 'gugur-pro' ),
				],
				'default' => 'call',
				'condition' => [
					'link_type' => 'skype',
