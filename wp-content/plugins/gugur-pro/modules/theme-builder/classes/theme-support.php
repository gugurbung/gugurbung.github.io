...
use gugurPro\Modules\ThemeBuilder\ThemeSupport\GeneratePress_Theme_Support;
use gugurPro\Modules\ThemeBuilder\ThemeSupport\Safe_Mode_Theme_Support;
...
class Theme_Support {
	...
	public function init() {
		...
		add_action( 'gugur/theme/register_locations', [ $this, 'after_register_locations' ], 99 );
	}
