...
class Single extends Theme_Page_Document {
	...
	public function preview_error_handler() {
		...
		wp_localize_script( 'gugur-frontend', 'gugurPreviewErrorArgs', [
			...
			'message' => sprintf( __( 'You must include the %1$s Widget in your template (%2$s), in order for gugur to work on this page.', 'gugur-pro' ), $depended_widget_title, '<strong>' . static::get_title() . '</strong>' ),
			'strings' => [
