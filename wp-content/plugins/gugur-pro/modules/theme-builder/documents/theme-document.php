...
abstract class Theme_Document extends Library_Document {
	...
	const LOCATION_META_KEY = '_gugur_location';
	...
	public function get_location_label() {
		...
		if ( ! $supported ) {
			$label .= ' (' . __( 'Unsupported', 'gugur-pro' ) . ')';
		}
	...
	public function get_container_attributes() {
		...
		if ( $location ) {
			$attributes['class'] .= ' gugur-location-' . $location;
		}
	...
	public function get_edit_url() {
		...
		if ( isset( $_GET['action'] ) && 'gugur_new_post' === $_GET['action'] ) {
			$url .= '#library';
		}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'preview_settings',
			[
				'label' => __( 'Preview Settings', 'gugur-pro' ),
		...
		$this->add_control(
			'preview_type',
			[
				'label' => __( 'Preview Dynamic Content as', 'gugur-pro' ),
				'label_block' => true,
		...
		$this->add_control(
			'preview_search_term',
			[
				'label' => __( 'Search Term', 'gugur-pro' ),
				'export' => false,
				'condition' => [
					'preview_type' => 'search',
				],
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Apply & Preview', 'gugur-pro' ),
				'label_block' => true,
				'show_label' => false,
				'text' => __( 'Apply & Preview', 'gugur-pro' ),
				'separator' => 'none',
	...
	public function get_wp_preview_url() {
		 ...
		 */
		$preview_url = apply_filters( 'gugur/document/wp_preview_url', $preview_url, $this );
