...
class Document extends Theme_Section_Document {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			'exit_animation',
			[
				'label' => __( 'Exit Animation', 'gugur-pro' ),
		...
		$this->add_control(
			'open_selector',
			[
				'label' => __( 'Open By Selector', 'gugur-pro' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( '#id, .class', 'gugur-pro' ),
				'description' => __( 'In order to open a popup on selector click, please set your Popup Conditions', 'gugur-pro' ),
				'frontend_available' => true,
			]
		);
